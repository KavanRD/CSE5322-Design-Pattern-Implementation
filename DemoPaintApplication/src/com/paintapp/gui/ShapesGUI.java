...
import com.paintapp.controller.BoxController;
import com.paintapp.controller.CircleController;
import com.paintapp.controller.RedoController;
import com.paintapp.controller.UndoController;
...
public class ShapesGUI extends javax.swing.JFrame{
	...
	private JButton box, circle, undo, redo;
    ...
    public ShapesGUI(String title)
    {
        ...
        rightPanel = new DrawCanvas();		// right drawing canvas panel
